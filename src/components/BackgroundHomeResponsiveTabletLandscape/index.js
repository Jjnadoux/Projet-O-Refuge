...
import './BackgroundHomeResponsiveTabletLandscape.css';

const BackgroundHomeResponsiveTabletLandscape = () => {
  const videoSource = "http://35.153.206.173/BackResponsiveVideo/orefugelandscapetablet.webm"
  return (
...
export default BackgroundHomeResponsiveTabletLandscape;
